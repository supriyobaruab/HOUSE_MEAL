...
const savedDailyCount = localStorage.getItem("dailyCount");
...
sadd_btn.addEventListener('click', () => {
    ...
    sdcount.innerHTML = sd_count;
    localStorage.setItem("dailyCount", sd_count);
});
// Remove button
...
s_submit.addEventListener('click', () => {
    ...
    getCall();
    sd_count = 0;  
    localStorage.setItem("dailyCount", sd_count);  // Reset daily count in localStorage        
});
